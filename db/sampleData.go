...
var SampleCharacters = []Character{
	{
		...
		LastName:  "Yeager",
		Age:       19,
		FromAnime: []string{"Attack on Titan"},
		Gender:    "Male",
	...
	},
	{
		...
		LastName:  "Midoriya",
		Age:       16,
		FromAnime: []string{"My Hero Academia"},
		Gender:    "Male",
	...
	},
	{
		...
		LastName:  "Ogino",
		Age:       10,
		FromAnime: []string{"Spirited Away"},
		Gender:    "Female",
